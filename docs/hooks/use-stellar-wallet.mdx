...
- [`useStellarPayment`](/docs/hooks/use-stellar-payment) - Advanced payment building and submission
- [`useStellarBalances`](/docs/hooks/use-stellar-balances) - Detailed balance tracking with real-time updates
- [`useTransactionHistory`](/docs/hooks/use-transaction-history) - View account transaction history
- [`useTrustlines`](/docs/hooks/use-trustlines#adding-and-removing-a-trustline) - Add and remove trustlines for the connected account
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  ...
  >
    ...
    <span className="text-sm text-muted-foreground block">Advanced payment transaction building</span>
  </a>
...
>
  ...
  >
    ...
    <span className="text-sm text-muted-foreground block">Complete payment application code</span>
  </a>
</div>
